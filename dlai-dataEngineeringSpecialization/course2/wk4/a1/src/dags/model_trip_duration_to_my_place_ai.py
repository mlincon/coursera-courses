...
def model_trip_duration_to_my_place_ai():
    ...
    data_quality_task = GreatExpectationsOperator(
        ...
        data_asset_name="train_to_my_place_ai",
    ...
    @task
    def notify(message):
        print(f"{message}. " "Notify to mail: admin@to_my_place_ai.com")
...
dag_model_trip_duration_to_my_place_ai = model_trip_duration_to_my_place_ai()