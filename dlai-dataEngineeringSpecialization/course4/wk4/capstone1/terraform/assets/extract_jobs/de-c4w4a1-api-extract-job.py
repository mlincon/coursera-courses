...
# Take a look at the parameters that it requires: a target path where data will be stored, the API endpoint URL, and a start and end date that are required by each API endpoint
